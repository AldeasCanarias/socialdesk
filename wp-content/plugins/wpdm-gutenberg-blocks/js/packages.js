                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(SelectControl, {
                            ...
                            value: attributes.cat_relation,
                            'class': "form-control wpdm-custom-select",
                            options: [{ label: 'Match All', value: 'AND' }, { label: 'Match Any', value: 'OR' }],
                            onChange: function onChange(cat_relation) {
                                return setAttributes({ cat_relation: cat_relation });
                            }
                        })
                    ),
                    React.createElement(CategorySelector, {
